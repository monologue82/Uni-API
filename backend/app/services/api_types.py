...
API_TYPE_PRESETS = [
    ...
    {"id": "deepseek", "name": "DeepSeek", "base_url": "https://api.deepseek.com", "api_key_header": "Authorization", "api_key_prefix": "Bearer ", "category": "LLM (OpenAI)", "format": "openai", "description": "DeepSeek-V4, DeepSeek-R1", "models_endpoint": "/v1/models", "models_key": "data.*.id"},
